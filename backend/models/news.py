...
from sqlalchemy import DateTime, func, Integer, String, Float, select, Index, Text, ForeignKey
...
class Category(Base):
    ...
    name: Mapped[str] = mapped_column(unique=True,nullable=False,comment="分类名称")
    sort_order: Mapped[int] = mapped_column(Integer,default=8,nullable=False,comment="排序")
